...
def customer_signup_view(request):
    ...
    return render(request,'ecom/register.html',context=mydict)
...
def checkout_view(request):
    customer=models.Customer.objects.get(user_id=request.user.id)
    return render(request,'ecom/checkout.html',{'customer':customer})
...
def singleproduct_view(request):
    return render(request, 'ecom/product-single.html')
